...
((SELECT COUNT(NUMCLIENT)+1 FROM CLIENT),"MURE","1, rue de la gauche","Strasbourg");

INSERT INTO CLIENT(NUMCLIENT,NOM,ADRESSE,LOCALITE)
-- client qui possède un contrat mais aucune voiture associé, il n'est donc pas impliqué dans un accident
((SELECT COUNT(NUMCLIENT)+1 FROM CLIENT),"KLEINCLAUS","20, rue de la bonne note","Vendenheim");

INSERT INTO CLIENT(NUMCLIENT,NOM,ADRESSE,LOCALITE)
--client qui ne possède deux voitures toutes les deux assurrées, qui sont impliqués dans le même accident
((SELECT COUNT(NUMCLIENT)+1 FROM CLIENT),"FOUBERT","2, rue de Strasbourg","Strasbourg");

INSERT INTO CLIENT(NUMCLIENT,NOM,ADRESSE,LOCALITE)
--client qui ne possède ni contrat ni voiture
((SELECT COUNT(NUMCLIENT)+1 FROM CLIENT),"HATTON","9, avenue de la forêt noire","Strasbourg");

INSERT INTO CLIENT(NUMCLIENT,NOM,ADRESSE,LOCALITE)
--client qui possède une voiture mais pas de contrat
((SELECT COUNT(NUMCLIENT)+1 FROM CLIENT),"BENIGNI","9,rue de la ziegelau", "Strasbourg");
...
((SELECT COUNT(NUMACC)+1 FROM ACCIDENT),'2017-05-02',1000);

INSERT INTO ACCIDENT(NUMACC,DATEACC,MONTANT)
--accident qui implique la voiture de Mure qui été assurée
((SELECT COUNT(NUMACC)+1 FROM ACCIDENT),'2017-04-30',10);

INSERT INTO ACCIDENT(NUMACC,DATEACC,MONTANT)
--accident qui implique la voiture de Mure avant qu'elle ne soit assurée (montant nul pas assuré ?)
((SELECT COUNT(NUMACC)+1 FROM ACCIDENT),'2017-03-10',null);

INSERT INTO ACCIDENT(NUMACC,DATEACC,MONTANT)
--accident qui implique les voiture de Foubert
((SELECT COUNT(NUMACC)+1 FROM ACCIDENT),'2017-02-13',500000);
...
((SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT"),(SELECT COUNT(NUMCTR)+1 FROM CONTRAT),"TOUT RISQUE",'2017-01-01');

INSERT INTO CONTRAT(SIGNATAIRE,NUMCTR,TYPE,DATESIGN)
--contrat de sa deuxième voiture de Foubert
((SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT"),(SELECT COUNT(NUMCTR)+1 FROM CONTRAT),"TOUT RISQUE",'2017-01-02');

INSERT INTO CONTRAT(SIGNATAIRE,NUMCTR,TYPE,DATESIGN)
--contrat de la voiture de Mure
((SELECT NUMCLIENT FROM CLIENT WHERE NOM="MURE"),(SELECT COUNT(NUMCTR)+1 FROM CONTRAT),"TOUT RISQUE",'2017-04-01'));

INSERT INTO CONTRAT(SIGNATAIRE,NUMCTR,TYPE,DATESIGN)
--contrat de Kleinclaus mais lié à aucune voiture
((SELECT NUMCLIENT FROM CLIENT WHERE NOM="KLEINCLAUS"),(SELECT COUNT(NUMCTR)+1 FROM CONTRAT),"TOUT RISQUE",'2017-01-01'));
...
((SELECT COUNT(NUMVEH)+1 FROM VEHICULE ),"LAMBORGHINI","AVENTADOR",2016,"6498 cc",(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT"),(SELECT NUMCTR FROM CONTRAT WHERE SIGNATAIRE=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT")),(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT")));

INSERT INTO VEHICULE(NUMVEH,MARQUE,MODELE,ANNEE,CYLINDREE,SIGNATAIRE,NUMCTR,NUMCLIENT)
--deuxième voiture de Foubert sous contrat
((SELECT COUNT(NUMVEH)+1 FROM VEHICULE ),"FIAT","PUNTO",2002,"3000 cc",(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT"),(SELECT NUMCTR FROM CONTRAT WHERE SIGNATAIRE=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT")),(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT")));

INSERT INTO VEHICULE(NUMVEH,MARQUE,MODELE,ANNEE,CYLINDREE,SIGNATAIRE,NUMCTR,NUMCLIENT)
--voiture de Mure sous contrat
((SELECT COUNT(NUMVEH)+1 FROM VEHICULE ),"RENAULT","TWINGO",2007,"1500 cc",(SELECT NUMCLIENT FROM CLIENT WHERE NOM="MURE"),(SELECT NUMCTR FROM CONTRAT WHERE SIGNATAIRE=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="MURE")),(SELECT NUMCLIENT FROM CLIENT WHERE NOM="MURE")));

INSERT INTO VEHICULE(NUMVEH,MARQUE,MODELE,ANNEE,CYLINDREE,SIGNATAIRE,NUMCTR,NUMCLIENT)
--voiture de Benigni sans contrat
((SELECT COUNT(NUMVEH)+1 FROM VEHICULE ),"FERRARI","F12",2015,"5000 cc",(SELECT NUMCLIENT FROM CLIENT WHERE NOM="BENIGNI"),(SELECT NUMCTR FROM CONTRAT WHERE SIGNATAIRE=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="BENIGNI")),(SELECT NUMCLIENT FROM CLIENT WHERE NOM="BENIGNI")));
...
((SELECT NUMACC FROM ACCIDENT WHERE DATEACC='2017-02-13'),(SELECT NUMVEH FROM VEHICULE WHERE NUMCLIENT=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT")));
INSERT INTO IMPLICATION(NUMACC,NUMVEH)
((SELECT NUMACC FROM ACCIDENT WHERE DATEACC='2017-02-13'),(SELECT NUMVEH FROM VEHICULE WHERE NUMCLIENT=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="FOUBERT")));

INSERT INTO IMPLICATION(NUMACC,NUMVEH)
--Première implication de la voiture de Mure dans un accident (pas encore sous contrat)
((SELECT NUMACC FROM ACCIDENT WHERE DATEACC='2017-03-10'),(SELECT NUMVEH FROM VEHICULE WHERE NUMCLIENT=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="MURE")));

INSERT INTO IMPLICATION(NUMACC,NUMVEH)
--Deuxième implication de la voiture de Mure dans un accident (sous contrat)
((SELECT NUMACC FROM ACCIDENT WHERE DATEACC='2017-04-30'),(SELECT NUMVEH FROM VEHICULE WHERE NUMCLIENT=(SELECT NUMCLIENT FROM CLIENT WHERE NOM="MURE")));